...
@InputType()
class ComplaintCreateNestedManyWithoutResidentsInput {
...
export { ComplaintCreateNestedManyWithoutResidentsInput as ComplaintCreateNestedManyWithoutResidentsInput };
